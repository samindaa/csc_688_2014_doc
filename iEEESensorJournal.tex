...
sensor reading sequentially and the lost data points were identified from this number and was 
...
clusters. Each segment has between 15 to 20 consecutive data points, which amounts to 
3000$ms$ to 4000$ms$ fall event after triggering the event. Each fall-event triggers 
...
local minimum in general. Moreover, the cluster assignments may vary depending on the 
...
We have developed a generic software platform for embedded devices. The software platform has been tested on combinations of microcontrollers and sensing devices. We have used it for creating a wireless sensor network and using the network for collecting motion data.
