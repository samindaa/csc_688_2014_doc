...
%The results
These networks are trained offline with training examples extracted  by our proposed method. Cross-validation of trained two-level networks show 100\% acuracy for non-fall activities and fall events. The dataset for training and testing have been collected using the devices we assembled with four off-the-shelf components and programmed them using a prototype of our proposed framework. The dataset include seven types of non-fall activities and four types of fall events.
%Conclusion reached
