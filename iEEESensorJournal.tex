...
\begin{figure*}[!t]
\centering
\subfloat[]{\label{fig:fa}\includegraphics[width=0.8\textwidth]{figures/graph_structure_def-crop3}}
...
solutions to access devices on the boosterpacks such as: \begin{inparaenum}[($i$)] \item InvenSense 
