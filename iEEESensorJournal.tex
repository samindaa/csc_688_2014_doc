...
direction of a fall. The method recognized the fall activity, only when a predetermined set of 
...
resembles falls such as sitting down on a chair. Their method detected fall events with recordings from different smart-phones with 84.8\% accuracy. 

Methods to detect simple and complex activities using reading from accelerometer and gyroscope of an Android smart-phone were explored in\cite{DernbachActivityAndFallDetectionPhone2012}. The simple activities including 
...
for complex activities.    
 ...
 In \cite{ShenFallDetectionPhone2015}, High-level fuzzy Petri nets were evaluated for the analysis and detection of normal human actions such as sitting-down, squatting, walking, running, and jumping and 
abnormal events such as falling forward, backward, sideways, and vertical. They 
 94\% accuracy for fall-detection. One disadvantage of their process was that, some complex situations 
