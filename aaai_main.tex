...
The annotation for different human and robot motion events are shown in Fig.{~\ref{fig:anotation-human-robot}}. Here accelerometer and gyroscope's X, Y and Z axis are showing for different motions. The time for a 
