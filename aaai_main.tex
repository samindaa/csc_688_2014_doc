...
The annotation for different human and robot motion event is shown in Fig.{~\ref{fig:anotation-human-robot}}. Here accelerometer's X, Y and Z axis is showing for a single fall event. The time for a 
