...
\begin{figure*}[!ht]
  \centering
  \subfloat[Marching.]{\label{fig:tsnedataset_1}\includegraphics[width=0.4\textwidth]
       {plot1-crop}}
  \subfloat[Fast walk forward.]{\label{fig:tsnedataset_5}\includegraphics[width=0.4\textwidth]
       {plot2-crop}}
\\
  \subfloat[Slow walk backward.]{\label{fig:tsnedataset_7}\includegraphics[width=0.4\textwidth]
       {plot3-crop}}
  \subfloat[Rotate
counter-clockwise.]{\label{fig:tsnedataset_8}\includegraphics[width=0.45\textwidth]
       {plot4-crop}}
       \\
  \subfloat[Fast walk backward.]{\label{fig:tsnedataset_9}\includegraphics[width=0.4\textwidth]
       {plot5-crop}}
  \subfloat[Left side-way walk.]{\label{fig:tsnedataset_10}\includegraphics[width=0.4\textwidth]
       {plot6-crop}}
...
\begin{figure*}[!ht]
  \centering
  \subfloat[Fallen forward.]{\label{fig:tsnedataset_11}\includegraphics[width=0.4\textwidth]
       {plot1_fallen-crop}}
  \subfloat[Fallen backward.]{\label{fig:tsnedataset_12}\includegraphics[width=0.4\textwidth]
       {plot2_fallen-crop}}
\\
  \subfloat[Fallen to left side.]{\label{fig:tsnedataset_13}\includegraphics[width=0.4\textwidth]
       {plot3_fallen-crop}}
  \subfloat[Fallen to right
side.]{\label{fig:tsnedataset_14}\includegraphics[width=0.4\textwidth]
       {plot4_fallen-crop}}      
