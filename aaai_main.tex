...
\begin{figure*}[!t]
\centering
\subfloat[]{\label{fig:fa}\includegraphics[width=0.57\textwidth]{figures/graph_structure_def-crop}} 
...
based on the powerful TM4C129), Sensor Hub BoosterPack, and CC2533 wireless transmitter and 
receiver (an add-on board designed to fit Tiva C Series TM4C123G LaunchPad along with all of TI’s 
MCU LaunchPads) provide ultimate solutions for a wide rage of low power and portable applications. 
...
\begin{figure*}[!t]
\centering
\subfloat[]{\label{fig:ha}\includegraphics[width=0.32\textwidth]{plots/human_walk-crop.pdf}} 
\subfloat[]{\label{fig:hb}\includegraphics[width=0.32\textwidth]{plots/human_stand-crop.pdf}}
\subfloat[]{\label{fig:hc}\includegraphics[width=0.32\textwidth]{plots/human_falling-crop.pdf}}
\\
\subfloat[]{\label{fig:ha}\includegraphics[width=0.32\textwidth]
{plots/robot_walk_forward-crop.pdf}}s 
\subfloat[]{\label{fig:hb}\includegraphics[width=0.32\textwidth]
{plots/robot_walk_backward-crop.pdf}}
\subfloat[]{\label{fig:hc}\includegraphics[width=0.32\textwidth]
...
The annotation for a single fall event is shown in \textbf{{set the figure} }. Here accelerometer's X, Y and Z axis is showing for a single fall event. The time for a 
actual event takes an average of 200 milliseconds. From
the figure, the area annotated as a fall is from 81 to 91 readings. This 20 readings take 200 milliseconds.The following
