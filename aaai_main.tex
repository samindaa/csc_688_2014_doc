...
\begin{figure*}[!t]
\centering
\subfloat[]{\label{fig:ha}\includegraphics[width=0.33\textwidth]{plots/human_walk-crop.pdf}} 
\subfloat[]{\label{fig:hb}\includegraphics[width=0.33\textwidth]{plots/human_stand-crop.pdf}}
\subfloat[]{\label{fig:hc}\includegraphics[width=0.33\textwidth]{plots/human_falling-crop.pdf}} 
\caption{~}
 \label{fig:human}
\end{figure*}
...
each data point has nine features, where three sensors accelerometer,gyroscope and magnetometers have three axis X, Y and Z.
