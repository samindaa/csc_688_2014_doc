...
TI microcontroller  boards such as MSP430{\texttrademark}LaunchPad, Tiva{\texttrademark} C Series 
...
forward.]{\label{fig:ha}\includegraphics[width=0.25\textwidth]{plots/human_walk-crop.pdf}} 
\subfloat[Human stand to 
seat.]{\label{fig:hb}\includegraphics[width=0.25\textwidth]{plots/human_stand-crop.pdf}}
%\subfloat[Human stand to 
...
\caption{Logistic regression and SVM classification for human activities.}
	...
	\scalebox{0.65}{
		...
		\hline
		 & \multicolumn{4}{c||}{Logistic regression} & \multicolumn{4}{c|}{SVM classification} \\ 
\hline
