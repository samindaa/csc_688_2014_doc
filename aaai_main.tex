...
generalizable. This paper is a step towards that direction to use wearable devices with sensors to 
...
\subfloat[Robot Rotate Clock Wise]{\label{fig:hc}\includegraphics[width=0.32\textwidth]
...
The annotation for different human and robot motion events are shown in Fig.{~\ref{fig:anotation-human-robot}}. Here accelerometer's X, Y and Z axis is showing for a single fall event. The time for a 
