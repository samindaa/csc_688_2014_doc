...
and Softmax regression networks.  Our empirical evaluations of the proposed \hl{two-layer network 
on both humans and humanoid robots show}
that seven types of non-fall activities and four types of fall events are classified on \hl{our datasets}
