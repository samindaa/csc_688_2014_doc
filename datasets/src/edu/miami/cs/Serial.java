...
import static edu.miami.cs.I18n._;
...
public class Serial implements SerialPortEventListener {
    ...
    public Serial(String iname, int irate,
        ...
        try {
            ...
            throw new SerialException(I18n.format(_("Serial port ''{0}'' already in use. Try quiting any programs that may be using it."),
                    iname));
        } catch (Exception e) {
...
//      //e.printStackTrace();
        ...
        if (port == null) {
            throw new SerialNotFoundException(I18n.format(_("Serial port ''{0}'' not found. Did you select the right one from the Tools > Serial Port menu?"),
                    iname));
        }
    }
